...
function SeoArticlePage() {
  ...
  return (
    <>
      ...
      <article className="light-page seo-article">
        <section className="light-page__hero" data-aos="fade-up">
          <div className="site-container">
            <p className="light-page__eyebrow">{article.groupLabel}</p>
            <h1>{article.title}</h1>
            <p>
          ...
          <div className="site-container">
            <div className="seo-article__layout">
              <div className="seo-article__body">
                ...
                <section className="light-page__article-block seo-article__block" data-aos="fade-up">
                ...
                <section className="light-page__article-block seo-article__block" data-aos="fade-up">
                  ...
                  <div className="seo-article__faq-list">
                    {article.faqs.map((faq, index) => (
                      <div
                        key={faq.question}
                        className="light-page__faq-item seo-article__faq-item"
                        data-aos="fade-up"
